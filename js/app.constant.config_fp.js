(function(){
  ...
  angular
    ...
    .constant('CONFIG', {
      ...
      'OBJECTIVE': 600,
      'TIME_LIMIT': 90,
      'LINK_SITE': 'http://pre-www.e-biz.fr/',
      'LINK_OFFERS': 'http://pre-www.e-biz.fr/jobs',
      'WIN': {
        'TITLE': 'Félicitations',
      ...
      'CIRCUITS': [{
        ...
        items: [
          ...
          { pos: { x: 126, y: 1108 }, type: 'BONUS', value: 1, libelle: 'Unity 3D', img: 'assets/img/items/unity.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 145, y: 1108 }, type: 'MALUS', value: 1, libelle: 'JQuery', img: 'assets/img/items/jquery.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 163, y: 1108 }, type: 'BONUS', value: 50, libelle: 'Gatling', img: 'assets/img/items/gatling.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 182, y: 1108 }, type: 'MALUS', value: 10, libelle: 'HAProxy', img: 'assets/img/items/haproxy.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: { x: 145, y: 932 }, type: 'MALUS', value: 10, libelle: 'Apache HBase', img: 'assets/img/items/apache-hbase.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 163, y: 932 }, type: 'MALUS', value: 5, libelle: 'Microsoft Azure', img: 'assets/img/items/azure.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 182, y: 932 }, type: 'MALUS', value: 10, libelle: 'Backbone JS', img: 'assets/img/items/backbonejs.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: { x: 314, y: 932 }, type: 'BONUS', value: 40, libelle: 'Docker', img: 'assets/img/items/docker.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 333, y: 932 }, type: 'MALUS', value: 30, libelle: 'CFEngine', img: 'assets/img/items/cfengine.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 352, y: 932 }, type: 'MALUS', value: 20, libelle: 'Ansible', img: 'assets/img/items/ansible.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 371, y: 932 }, type: 'BONUS', value: 50, libelle: 'Android', img: 'assets/img/items/android.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 390, y: 932 }, type: 'BONUS', value: 100, libelle: 'Angular', img: 'assets/img/items/Angular.png', move: { type: 'stay' }, timeout: 0 },
          // FIRST SPECIAL ITEM
          ...
          { pos: { x: 412, y: 1185 }, type: 'MALUS', value: 20, libelle: 'HAProxy', img: 'assets/img/items/haproxy.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 412, y: 1204 }, type: 'BONUS', value: 50, libelle: 'CSS 3', img: 'assets/img/items/css3.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 412, y: 1223 }, type: 'MALUS', value: 20, libelle: 'Thymeleaf', img: 'assets/img/items/thymeleaf.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: { x: 537, y: 860 }, type: 'MALUS', value: 1, libelle: 'JQuery', img: 'assets/img/items/jquery.png', move: { type: 'stay' }, timeout: 0 },
          // SECOND LINE IN PARK (ON FIRST BRIDGE)
          { pos: { x: 625, y: 776 }, type: 'BONUS', value: 40, libelle: 'Git', img: 'assets/img/items/git.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 625, y: 796 }, type: 'MALUS', value: 30, libelle: 'GCE', img: 'assets/img/items/gce.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: {x:977, y:754}, type: 'MALUS', value: 5, libelle: '.NET', img: 'assets/img/items/dotnet.png', timeout: 0, move: {
            type: 'path', iterations: 1500, path:[
              {x:977, y:754}, {x:930, y:751}, {x:885, y:755}, {x:856, y:768},  {x:832, y:794},  {x:822, y:828},
              {x:840, y:865}, {x:865, y:887},
              {x:923, y:896}, {x:964, y:892}, {x:994, y:871}, {x:1022, y:847}, {x:1027, y:806}, {x:1011, y:771}
          ...
          { pos: {x:840, y:865}, type: 'BONUS', value: 30, libelle: 'IOS', img: 'assets/img/items/ios.png', timeout: 0, move: {
            type: 'path', iterations: 1500, path:[
              {x:840, y:865}, {x:865, y:887},
              {x:923, y:896}, {x:964, y:892}, {x:994, y:871}, {x:1022, y:847}, {x:1027, y:806}, {x:1011, y:771},
              {x:977, y:754}, {x:930, y:751}, {x:885, y:755}, {x:856, y:768},  {x:832, y:794},  {x:822, y:828}
          ...
          // SECOND LINE IN PARK
          { pos: { x: 1085, y: 817 }, type: 'BONUS', value: 40, libelle: 'Ionic', img: 'assets/img/items/ionic.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 1085, y: 832 }, type: 'MALUS', value: 30, libelle: 'JSP', img: 'assets/img/items/jsp.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: { x: 1125, y: 701 }, type: 'MALUS', value: 20, libelle: 'Knime', img: 'assets/img/items/knime.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 1137, y: 695 }, type: 'BONUS', value: 25, libelle: 'Karma', img: 'assets/img/items/karma.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 1151, y: 691 }, type: 'MALUS', value: 30, libelle: 'JSP', img: 'assets/img/items/jsp.png', move: { type: 'stay' }, timeout: 0 },
          // THIRD SPECIAL ITEM
          ...
          { pos: { x: 1000, y: 615 }, type: 'MALUS', value: 30, libelle: 'Hadoop', img: 'assets/img/items/hadoop.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: { x: 840, y: 580 }, type: 'MALUS', value: 40, libelle: 'Mysql', img: 'assets/img/items/mysql.png',
          ...
          // LINE ON BIG BRIDGE
          { pos: { x: 556, y: 667 }, type: 'BONUS', value: 70, libelle: 'NodeJS', img: 'assets/img/items/nodejs.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 568, y: 652 }, type: 'BONUS', value: 30, libelle: 'Protractor', img: 'assets/img/items/protractor.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 580, y: 641 }, type: 'BONUS', value: 100, libelle: 'ReactJS', img: 'assets/img/items/reactjs.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 595, y: 628 }, type: 'MALUS', value: 40, libelle: 'Spark', img: 'assets/img/items/spark.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 605, y: 623 }, type: 'MALUS', value: 30, libelle: 'Redis', img: 'assets/img/items/redis.png', move: { type: 'stay' }, timeout: 0 },
          // FIRST LINE AFTER BIG BRIDGE
          { pos: { x: 700, y: 461 }, type: 'MALUS', value: 30, libelle: 'Puppet', img: 'assets/img/items/puppet.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 700, y: 484 }, type: 'BONUS', value: 40, libelle: 'Redux', img: 'assets/img/items/redux.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 700, y: 506 }, type: 'MALUS', value: 35, libelle: 'Splunk', img: 'assets/img/items/splunk.png', move: { type: 'stay' }, timeout: 0 },
          ...
          { pos: {x:751, y:323}, type: 'MALUS', value: 25, libelle: 'Hortonworks', img: 'assets/img/items/hortonworks.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:800, y:252}, type: 'MALUS', value: 35, libelle: 'Logom', img: 'assets/img/items/logom.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:767, y:243}, type: 'MALUS', value: 45, libelle: 'Chef', img: 'assets/img/items/chef.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:785, y:154}, type: 'BONUS', value: 100, libelle: 'Scrum', img: 'assets/img/items/scrum.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:710, y:165}, type: 'MALUS', value: 40, libelle: 'Vagrant', img: 'assets/img/items/vagrant.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:658, y:241}, type: 'MALUS', value: 50, libelle: 'PostGIS', img: 'assets/img/items/PostGIS.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:539, y:222}, type: 'MALUS', value: 40, libelle: 'PostgreSQL', img: 'assets/img/items/postgresql.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
              {x:539, y:222}, {x:552, y:253}, {x:569, y:273}, {x:601, y:279}, {x:627, y:283}, {x:654, y:264},
              {x:658, y:241}, {x:652, y:213}, {x:633, y:189}, {x:601, y:171}, {x:576, y:169}, {x:556, y:194}
            ]}
          ...
          { pos: {x:593, y:304}, type: 'MALUS', value: 45, libelle: 'Apache Kafka', img: 'assets/img/items/kafka.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:559, y:356}, type: 'MALUS', value: 30, libelle: 'Puppet', img: 'assets/img/items/puppet.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
          ...
          { pos: {x:627, y:326}, type: 'BONUS', value: 70, libelle: 'NodeJS', img: 'assets/img/items/nodejs.png', timeout: 0, move: {
            type: 'path', iterations: 1000, path:[
              {x:627, y:326}, {x:593, y:304}, {x:561, y:320}, {x:559, y:356}, {x:594, y:367}, {x:622, y:360}
            ]}
          },
          // FOURTH SPECIAL ITEM
          { pos: { x: 922, y: 78 }, type: 'SUPER_BONUS', value: 15, libelle: 'Bower', img: 'assets/img/items/bower.png', move: { type: 'stay' }, timeout: 0 },
          // FIRST LINE AFTER BIG BRIDGE
          { pos: { x: 473, y: 120 }, type: 'MALUS', value: 30, libelle: 'BackboneJS', img: 'assets/img/items/backbonejs.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 473, y: 140 }, type: 'BONUS', value: 40, libelle: 'Cordova', img: 'assets/img/items/cordova.png', move: { type: 'stay' }, timeout: 0 },
          { pos: { x: 473, y: 160 }, type: 'MALUS', value: 5, libelle: '.NET', img: 'assets/img/items/dotnet.png', move: { type: 'stay' }, timeout: 0 },
          // LAST COMEBACK ITEMS LINE
          { pos: { x: 250, y: 100 }, type: 'BONUS', value: 50, libelle: 'GIT', img: 'assets/img/items/git.png',
            move: { type: 'comeback', goX: 250, goY: 195, iterations: 100 }, timeout: 0 },
          { pos: { x: 270, y: 100 }, type: 'MALUS', value: 1, libelle: 'JQuery', img: 'assets/img/items/jquery.png',
          ...
          { pos: { x: 310, y: 100 }, type: 'BONUS', value: 100, libelle: 'HTML 5', img: 'assets/img/items/html5.png',
            move: { type: 'comeback', goX: 310, goY: 195, iterations: 100 }, timeout: 0 },
          { pos: { x: 330, y: 100 }, type: 'MALUS', value: 25, libelle: 'Logom', img: 'assets/img/items/logom.png',
      ...
      'DRIVERS': [{
        name: 'Jawg Bald',
        sprites: {
          'FRONT':       { url: 'assets/img/kart/drivers/villager/villager-front.png', mat: null },
          'FACE':        { url: 'assets/img/kart/drivers/villager/villager-front.png',  mat: null },
          'SELECT':      { url: 'assets/img/kart/drivers/villager/villager-front.png',  mat: null },
          'SEE_LEFT':    { url: 'assets/img/kart/drivers/villager/villager-left.png',  mat: null },
          'SEE_RIGHT':   { url: 'assets/img/kart/drivers/villager/villager-right.png', mat: null },
          'TURN_LEFT':   { url: 'assets/img/kart/drivers/villager/villager-left.png',  mat: null },
          'TURN_RIGHT':  { url: 'assets/img/kart/drivers/villager/villager-right.png', mat: null },
          'DRIFT_LEFT':  { url: 'assets/img/kart/drivers/villager/villager-left.png',  mat: null },
          'DRIFT_RIGHT': { url: 'assets/img/kart/drivers/villager/villager-right.png', mat: null }
        },
        smokeSprites: {
        ...
        name: 'Gatling',
        sprites: {
          'FRONT': { url: 'assets/img/kart/drivers/takoman/takoman-front.png', mat: null },
          'FACE': { url: 'assets/img/kart/drivers/takoman/takoman-face.png', mat: null },
          'SELECT': { url: 'assets/img/kart/drivers/takoman/takoman-select-face.png', mat: null },
          'SEE_LEFT': { url: 'assets/img/kart/drivers/takoman/takoman-see-left.png', mat: null },
          'SEE_RIGHT': { url: 'assets/img/kart/drivers/takoman/takoman-see-right.png', mat: null },
          'TURN_LEFT': { url: 'assets/img/kart/drivers/takoman/takoman-turn-left.png', mat: null },
          'TURN_RIGHT': { url: 'assets/img/kart/drivers/takoman/takoman-turn-right.png', mat: null },
          'DRIFT_LEFT': { url: 'assets/img/kart/drivers/takoman/takoman-drift-left.png', mat: null },
          'DRIFT_RIGHT': { url: 'assets/img/kart/drivers/takoman/takoman-drift-right.png', mat: null }
        },
        smokeSprites: {
          'DRIFT_LEFT_1':  { url: 'assets/img/misc/drift_left_1.png'},
          'DRIFT_LEFT_2':  { url: 'assets/img/misc/drift_left_2.png'},
        ...
        name: 'Yoshi',
        sprites: {
          'FRONT': { url: 'assets/img/kart/drivers/yoshi/yoshi-front.png', mat: null },
          'FACE': { url: 'assets/img/kart/drivers/yoshi/yoshi-face.png', mat: null },
          'SELECT': { url: 'assets/img/kart/drivers/yoshi/yoshi-face.png', mat: null },
          'SEE_LEFT': { url: 'assets/img/kart/drivers/yoshi/yoshi-see-left.png', mat: null },
          'SEE_RIGHT': { url: 'assets/img/kart/drivers/yoshi/yoshi-see-right.png', mat: null },
          'TURN_LEFT': { url: 'assets/img/kart/drivers/yoshi/yoshi-turn-left.png', mat: null },
          'TURN_RIGHT': { url: 'assets/img/kart/drivers/yoshi/yoshi-turn-right.png', mat: null },
          'DRIFT_LEFT': { url: 'assets/img/kart/drivers/yoshi/yoshi-drift-left.png', mat: null },
          'DRIFT_RIGHT': { url: 'assets/img/kart/drivers/yoshi/yoshi-drift-right.png', mat: null }
        },
        smokeSprites: {
          'DRIFT_LEFT_1':  { url: 'assets/img/misc/drift_left_1.png'},
          'DRIFT_LEFT_2':  { url: 'assets/img/misc/drift_left_2.png'},
        ...
        name: 'iBiz',
        sprites: {
          'FRONT':       { url: 'assets/img/kart/drivers/steeve/steeve-front.png', mat: null },
          'FACE':        { url: 'assets/img/kart/drivers/steeve/steeve-front.png',  mat: null },
          'SELECT':      { url: 'assets/img/kart/drivers/steeve/steeve-select-face.png',  mat: null },
          'SEE_LEFT':    { url: 'assets/img/kart/drivers/steeve/steeve-left.png',  mat: null },
          'SEE_RIGHT':   { url: 'assets/img/kart/drivers/steeve/steeve-right.png', mat: null },
          'TURN_LEFT':   { url: 'assets/img/kart/drivers/steeve/steeve-left.png',  mat: null },
          'TURN_RIGHT':  { url: 'assets/img/kart/drivers/steeve/steeve-right.png', mat: null },
          'DRIFT_LEFT':  { url: 'assets/img/kart/drivers/steeve/steeve-left.png',  mat: null },
          'DRIFT_RIGHT': { url: 'assets/img/kart/drivers/steeve/steeve-right.png', mat: null }
        },
        smokeSprites: {
          'DRIFT_LEFT_1':  { url: 'assets/img/misc/drift_left_1.png'},
          'DRIFT_LEFT_2':  { url: 'assets/img/misc/drift_left_2.png'},
